...
public sealed class SqliteRecurringTaskInstanceStore(NaggerDbContext database) : IRecurringTaskInstanceStore
{
    ...
    {
        var entity = new RecurringTaskInstanceEntity
        {
            RecurringTaskId = instance.RecurringTaskId,
            Title = instance.Title,
            DueAt = instance.DueAt,
            ReminderPolicy = instance.ReminderPolicy.ToContractValue(),
    ...
    public async ValueTask<IReadOnlyList<RecurringTaskInstance>> GetByTemplateIdAsync(
