...
{
    public static TaskResponse From(TaskItem task) => new(task.Id, task.Title, "one-shot", "active", task.DueAt, task.ReminderPolicy.ToContractValue(), task.CreatedAt, task.UpdatedAt);
}
