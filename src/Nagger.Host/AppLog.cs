...
public static partial class AppLog
{
    ...
    [LoggerMessage(
        ...
        Message = "Dispatch {MessageType} completed in {ElapsedMs}ms"
    )]
    ...
    [LoggerMessage(
        ...
        Message = "Dispatch {MessageType} rejected by validation ({ErrorType}) in {ElapsedMs}ms"
    )]
    public static partial void DispatchValidationFailed(
        ILogger logger,
        string messageType,
        string errorType,
        long elapsedMs
