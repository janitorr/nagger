...
{
    public static bool TryParse(string? value, out ReminderPolicy policy) =>
        value switch
        {
    ...
    public static string ToContractValue(this ReminderPolicy policy) =>
        policy switch
        {
    ...
    public static ReminderPolicy FromContractValue(string value) =>
        value switch
        {
