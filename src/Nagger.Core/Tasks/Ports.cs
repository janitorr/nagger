...
public interface ITaskStore
{
    ...
    ValueTask<IReadOnlyList<TaskItem>> GetOpenOneShotTasksAsync(
...
public interface IRecurringTaskTemplateStore
{
    ...
    ValueTask<IReadOnlyList<RecurringTaskTemplate>> GetAllAsync(
        CancellationToken cancellationToken
    );
}
...
{
    ValueTask<RecurringTaskInstance> AddAsync(
    ...
    ValueTask<IReadOnlyList<RecurringTaskInstance>> GetActiveAsync(
        CancellationToken cancellationToken
    );
