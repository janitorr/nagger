...
The service SHALL reject a recurring task creation request whose `startDate` is not in YYYY-MM-DD format, whose `recurrence.every` is not a positive integer, or whose `recurrence.unit` is not days, weeks, or months.
